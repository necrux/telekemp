...
resource "aws_instance" "control_plane" {
  ...
  user_data          = templatefile("scripts/bootstrap.sh", {
    ...
    CERT_MANAGER     = tostring(var.deploy_cert_manager),
    CERT_MANAGER_VER = var.cert_manager_version,
    ...
    NGINX            = tostring(var.deploy_nginx_ingress),
    ISTIO            = tostring(var.deploy_istio),
